...
public class PromptSettingsPanel extends AbstractSettingsPanel {
    ...
    public PromptSettingsPanel(SettingLayout settingLayout) {
        // 初始化主面板
    ...
    protected void initComponents(SettingLayout settingLayout, AbstractSettingsPanel that) {
        settingLayout.getPanel(ModelArgsSettingsPanel.class).promptPanel(settingLayout, that);
    }
