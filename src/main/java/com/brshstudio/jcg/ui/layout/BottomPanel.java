...
import com.brshstudio.jcg.i18n.jcomponents.I18nProgressBar;
 ...
 * 底部面板类
 */
public class BottomPanel extends I18nPanel {

    /**
     * 进度条
     */
    private final I18nProgressBar progressBar;

    /**
     * 启动按钮标识
     */
    private final I18nButton startBtn;

    /**
     * 停止按钮标识
     */
    private final I18nButton stopBtn;
    ...
    public BottomPanel() {
        ...
        // 进度条样式
        progressBar = new I18nProgressBar(0, 10000);
        // 开启字符显示
